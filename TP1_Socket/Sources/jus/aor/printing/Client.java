	...
	private void onePrint(File f){
		...
		try(InputStream fis = new FileInputStream(f)){
			...
			if(retour == REPLY_PRINT_OK) {
                            ...
                            System.out.println("jus.aor.printing.Client.onePrint()" + j.toString());
                            System.out.println("jus.aor.printing.Client.onePrint()" + reponse.toString());
                            if(!(j.equals(reponse))){
                                log.log(java.util.logging.Level.SEVERE, "Mauvais JobKey reçu");
                            }
				//------------------------------------------------------------------------ A COMPLETER
